...
<head>
    ...
    <title>Qr Purchase Receipt</title>
    <style>
        body {
...
<body>
    <div class="receipt-container">
        <h1>Qr Purchase Receipt</h1>
        <p>Hi! {{ $data['userName'] }},</p>
        <p>You have purchased {{ $data['qr_codes'] }} QR codes.</p>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:22px 10px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Purchase
                                                                        Receipt </span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">You
                                                                        Have Purchased
                                                                        <span
                                                                            style="line-height: 19.6px;">{{ $data['qr_codes'] }}</span>
                                                                        number of QR Codes.</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Amount
                                                                        Paid : {{ $data['amount'] }}</span>
                                                                </p>
                                                            </div>
