...
<body>
    <div class="container">
        ...
        <div class="contact-info">
            <p class="info-label">Name: {{ $data['name'] }}</p>
            <p class="info-value"></p>

            <p class="info-label">Email: {{ $data['email'] }}</p>
            <p class="info-value"></p>

            <p class="info-label">Subject: {{ $data['subject'] }}</p>
            <p class="info-value"></p>

            <p class="info-label">Message: {{ $data['message'] }}</p>
            <p class="info-value"></p>
        </div>
    </div>
</body>
                ...
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Lato',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:22px 10px 30px;font-family:'Lato',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Contact</span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Hello
                                                                        Admin,</span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">{{ $data['name'] }}
                                                                        <span style="line-height: 19.6px;">wants</span>
                                                                        to connect with you</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Here
                                                                        are following details </span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>

                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Email:
                                                                        <a style="color:white !important;"
                                                                            href="#">{{ $data['email'] }}</a>
                                                                    </span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Subject:
                                                                        {{ $data['subject'] }} </span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Message:
                                                                        {{ $data['message'] }} </span>
                                                                </p>
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: #f9f9f9">
                        <div class="u-row"
                            ...
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: #f9f9f9;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #1a365d;"><![endif]-->
