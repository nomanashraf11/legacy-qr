                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Open
                                                                        this link to
                                                                        <span
                                                                            style="line-height: 19.6px;">verify</span>
                                                                        your email.</span></p>
                                                                <p
                                                                    style="font-size: 14px; line-height: 140%; color:white !important;">
                                                                </p>
                                                                <p
                                                                    style="font-size: 14px; line-height: 140%; color:white !important;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 25.2px; color:white !important;"><a
