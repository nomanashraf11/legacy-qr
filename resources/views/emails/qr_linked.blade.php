...
<body>
    <div class="linked-container">
        <h1>QR Code Linked</h1>
        <p>Hi {{ $data['userName'] }},</p>
        <p>You are now linked with the following QR Code ID:</p>
        <p class="qr-code">{{ $data['qr_code'] }}</p>
    </div>
</body>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:22px 10px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Account
                                                                        Registration </span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        Registration
                                                                        <span style="line-height: 19.6px;">with</span>
                                                                        this QR Code : {{ $data['qr_code'] }} was
                                                                        successful</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #ecf0f1;">Click
