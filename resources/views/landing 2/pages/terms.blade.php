...
@section('content')
    <div class="container max-width-xs mt-2">
        <header class="pt-24 ">
        ...
        <div class="pt-10 legal" style="max-width: 800px;margin:auto;">
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
                ...
                of the Company's stated services, in accordance with and subject to, prevailing law of as. Any use of the
            ...
            <p>We employ the use of cookies. By accessing Living Legacy, you agreed to use cookies in agreement with the
                Living Legacy's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Living Legacy and/or its licensors own the intellectual property rights for all
                material on Living Legacy. All intellectual property rights are reserved. You may access this from Living
                Legacy for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Living Legacy</li>
                <li>Sell, rent or sub-license material from Living Legacy</li>
                <li>Reproduce, duplicate or copy material from Living Legacy</li>
                <li>Redistribute content from Living Legacy</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                areas of the website. Living Legacy does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of Living Legacy,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
                extent permitted by applicable laws, Living Legacy shall not be liable for the Comments or for any
            ...
            <p>Living Legacy reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Living Legacy a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                ...
                Living Legacy; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
                you must inform us by sending an e-mail to Living Legacy. Please include your name, your organization name,
            ...
            <p>No use of Living Legacy's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
