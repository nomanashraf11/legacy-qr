...
export function ImageCropModal({
    ...
    const cropMode = ratio === "dp" ? "avatar" : "cover";

    const { mutate, isPending } = useMutation({
        mutationFn: ({ pixels, url, fileName, mode }) =>
            getCroppedImg(url, pixels, fileName, { mode }),
    });
            ...
            <div className="relative p-4 w-full max-w-[500px] max-h-full">
                <div className="relative bg-[#242526] rounded-lg shadow">
                    ...
                    <div className="p-4 md:p-6">
                        <div className="relative h-[220px] sm:h-[300px] md:h-[340px] w-full">
                            <Cropper
                                image={imageURL}
                                crop={crop}
                                zoom={zoom[1]}
                                aspect={ratio === "dp" ? 1 : 16 / 9}
                                style={{
                                    cropAreaStyle: {
